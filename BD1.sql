...
-- -----------------------------------------------------
-- Table `Proyecto`.`Parques`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Proyecto`.`Parques` (
...
-- -----------------------------------------------------
-- Table `Proyecto`.`Tipo_Entrada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Proyecto`.`Tipo_Entrada` (
...
-- -----------------------------------------------------
-- Table `Proyecto`.`Entradas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Proyecto`.`Entradas` (
  ...
  CONSTRAINT `fk_Entradas_Tipo_Entrada1`
    ...
    REFERENCES `Proyecto`.`Tipo_Entrada` (`id_Tipo_Entrada`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entradas_Parques1`
    FOREIGN KEY (`FK_Parque`)
    REFERENCES `Proyecto`.`Parques` (`id_Parque`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entradas_Factura1`
    FOREIGN KEY (`FK_Factura`)
    REFERENCES `Proyecto`.`Factura` (`id_Factura`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
